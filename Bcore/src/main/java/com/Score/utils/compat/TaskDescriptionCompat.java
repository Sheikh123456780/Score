...
import com.Score.utils.DrawableUtils;
...
public class TaskDescriptionCompat {
    public static ActivityManager.TaskDescription fix(ActivityManager.TaskDescription td) {
        ...
        ActivityManager am = (ActivityManager) ScoreCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    private static CharSequence getApplicationLabel() {
        try {
            PackageManager pm = ScoreCore.getPackageManager();
