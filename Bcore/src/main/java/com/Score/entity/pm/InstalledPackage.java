...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return ScoreCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return ScoreCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
