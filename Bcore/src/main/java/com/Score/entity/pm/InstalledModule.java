...
public class InstalledModule implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return ScoreCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, BUserHandle.USER_XPOSED);
    }

    public PackageInfo getPackageInfo() {
        return ScoreCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, BUserHandle.USER_XPOSED);
    }
