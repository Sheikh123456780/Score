...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    protected void onBindMethod() {
        ...
        // Android 10 and older keep these permission calls on IPackageManager.
    ...
    public static class GrantRuntimePermission extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (pkg != null && permission != null && VirtualPermissionCompat.isRuntimePermission(permission)) {
                // The Android permission controller owns the real grant. The
                // virtual package must not be registered as a real package.
                // Its subsequent permission checks are bridged to the host.
                return null;
            }
            return method.invoke(who, args);
        }
