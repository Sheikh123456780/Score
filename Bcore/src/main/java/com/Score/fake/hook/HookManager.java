...
import com.Score.fake.service.IPermissionCheckerProxy;
...
public class HookManager {
    ...
    public void init() {
        if (ScoreCore.get().isBlackProcess() || ScoreCore.get().isServerProcess()) {
            ...
            // Android 10+ uses PermissionChecker/AttributionSource for sensitive
            // data delivery such as microphone access.
