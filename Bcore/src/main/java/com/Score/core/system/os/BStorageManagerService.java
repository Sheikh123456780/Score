package com.Score.core.system.os;
...
import com.Score.fake.provider.FileProvider;
...
public class BStorageManagerService extends IBStorageManagerService.Stub implements ISystemService {
    ...
    public Uri getUriForFile(String file) throws RemoteException {
        return FileProvider.getUriForFile(ScoreCore.getContext(), ProxyManifest.getProxyFileProvider(), new File(file));
    }
