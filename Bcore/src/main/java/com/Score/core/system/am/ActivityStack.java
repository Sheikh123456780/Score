package com.Score.core.system.am;
...
import com.Score.core.system.pm.BPackageManagerService;
import com.Score.core.system.pm.PackageManagerCompat;
import com.Score.proxy.ProxyActivity;
...
public class ActivityStack {
    ...
    public ActivityStack() {
        mAms = (ActivityManager) ScoreCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    private int startActivityInNewTaskLocked(int userId, Intent intent, ActivityInfo
        ...
        ScoreCore.getContext().startActivity(shadow);
        return 0;
    }
    ...
    private int realStartActivityLocked(IInterface appThread, Intent intent, String resolvedType,
        ...
        try {
            ...
            BRIActivityManager.get(BRActivityManagerNative.get().getDefault()).startActivity(appThread, ScoreCore.getHostPkg(), intent,
    ...
    private Intent getStartStubActivityIntentInner(Intent intent, int vpid,
        ...
        try {
            Resources resources = PackageManagerCompat.getResources(ScoreCore.getContext(), activityInfo.applicationInfo);
            int id;
            ...
            if (windowIsTranslucent) {
                shadow.setComponent(new ComponentName(ScoreCore.getHostPkg(), ProxyManifest.TransparentProxyActivity(vpid)));
            } else {
                shadow.setComponent(new ComponentName(ScoreCore.getHostPkg(), ProxyManifest.getProxyActivity(vpid)));
            }
    ...
    public ComponentName getCallingActivity(IBinder token, int userId) {
        synchronized (mTasks) {
            ...
            return new ComponentName(ScoreCore.getHostPkg(), ProxyActivity.P0.class.getName());
        }
    }
