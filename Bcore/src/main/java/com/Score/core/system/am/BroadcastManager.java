...
import com.Score.core.system.pm.BPackage;
import com.Score.core.system.pm.BPackageManagerService;
import com.Score.core.system.pm.BPackageSettings;
import com.Score.core.system.pm.PackageMonitor;
import com.Score.entity.am.PendingResultData;
import com.Score.proxy.ProxyBroadcastReceiver;
            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ScoreCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_EXPORTED);
                    }else{
                        ScoreCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            ScoreCore.getContext().unregisterReceiver(broadcastReceiver);
