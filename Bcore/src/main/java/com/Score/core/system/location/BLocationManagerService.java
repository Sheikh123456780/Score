package com.Score.core.system.location;
...
import com.Score.entity.location.BCell;
import com.Score.entity.location.BLocation;
import com.Score.entity.location.BLocationConfig;
import com.Score.fake.frameworks.BLocationManager;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                ScoreCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
