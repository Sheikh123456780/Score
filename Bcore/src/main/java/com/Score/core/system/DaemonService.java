...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = ScoreCore.getHostPkg().hashCode();
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".SdCard_core")
